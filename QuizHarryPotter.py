...
#Carnet: 2262015      
#Autor: Alvaro Abraham Lemus Santizo
#Carnet: 1631320
...
while True:
    ...
    if puntos <= 13 :
        print (nombre, "El total de tus puntos son:", puntos)
        print (nombre, "Eres un simple Muugle :(")
    elif puntos <= 25 :
        print (nombre, "El total de tus puntos son:", puntos)
        print (nombre,"Eres un Muggle Sangre Sucia :/")
    elif puntos <= 35:
        print (nombre, "El total de tus putos son:", puntos)
        print (nombre,"Eres un Mago Sangre Mestiza :)")
    elif puntos <= 45:
        print (nombre, "El total de tus puntos son:", puntos)
        print (nombre, "Eres un Mago Sangre Pura :D")
        clear ()
    
    seguir = input (nombre, "Deseas seguir jugando si / no: ")
    clear ()
    ...
    if seguir == "si" or seguir == "Si":
        ...
        print (nombre, "¡Gracias por participar!")
        break
input ()